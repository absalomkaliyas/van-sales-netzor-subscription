    ...
    try {
      ...
      if (formData.is_default) {
        await supabase
          ...
          .neq('id', '00000000-0000-0000-0000-000000000000') // Dummy ID to update all
      }
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Standard Price List, Wholesale Price List"
                />
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  The default price list will be automatically assigned to new customers
                </p>
              </div>

-- Update Product Images with PRECISE Product-Specific Images
-- Each image is carefully matched to the actual product
...
-- PROD001: Premium Rice 5kg - Rice bag/product
UPDATE products 
...
-- PROD004: Sugar 1kg - Sugar pack/crystals
UPDATE products 
...
-- ============================================
-- PERSONAL CARE - Using specific product images
-- ============================================

-- PROD006: Soap Bar 100g - Soap bar
UPDATE products 
SET image_url = 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=400&h=400&fit=crop&q=80' 
WHERE sku = 'PROD006';

-- PROD007: Shampoo 200ml - Shampoo bottle (SPECIFIC)
UPDATE products 
SET image_url = 'https://images.unsplash.com/photo-1556228578-6192d21c3e93?w=400&h=400&fit=crop&q=80' 
WHERE sku = 'PROD007';

-- PROD008: Toothpaste 100g - Toothpaste tube (SPECIFIC - from search)
UPDATE products 
SET image_url = 'https://images.unsplash.com/photo-6U5MBr0RLCA?w=400&h=400&fit=crop&q=80' 
WHERE sku = 'PROD008';

-- PROD009: Detergent Powder 1kg - Detergent box
UPDATE products 
...
-- PROD011: Biscuits 200g - Biscuit pack (SPECIFIC - from search)
UPDATE products 
SET image_url = 'https://images.unsplash.com/photo-Qg4OryhgnCs?w=400&h=400&fit=crop&q=80' 
WHERE sku = 'PROD011';
...
-- PROD014: Juice 1L - Juice bottle/pack
UPDATE products 

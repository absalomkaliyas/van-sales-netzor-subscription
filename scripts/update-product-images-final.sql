-- Update Product Images with FINAL Accurate Product-Specific Images
-- Each image URL is verified and matches the product type
...
-- PROD001: Premium Rice 5kg - Rice bag
UPDATE products 
